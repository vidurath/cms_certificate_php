...
<div class="wrapper">
 ...
 <?php require_once 'assets/nav.php' ?>
  ...
  <div class="content-wrapper">
    ...
    $stmt=$conn2->prepare("SELECT a.`ticketid` AS ticketid, a.`cf_1006` AS serial_number, a.`cf_1012` AS registered_owner, a.`cf_1012` AS organisation_name,
    a.`cf_1002` AS invoice_no, a.`cf_1041` AS invoice_amount, a.`cf_1003` AS vehicle_reg_no, a.`cf_1008` AS engine_number, a.`cf_1009` AS chassis_number,
    a.`cf_1050` AS vehicle_detail, a.`cf_695` AS delivery_date, a.`cf_696` AS address_detail, a.cf_697 AS telephone,
    b.`ticket_no`, b.`title`, b.`parent_id`,
    c.`crmid`,c.`description`, d.`commentid`,d.`comments`,d.`ownerid`,e.`accountname`
    ...
    INNER JOIN vtiger_account e ON b.`parent_id` = e.`accountid`
  ...
  if($result->num_rows>0){
    ...
    <div class="card card-primary card-outline">
      ...
      <h3 class="profile-username text-center"><strong>Organization Name :</strong> <?php echo $row['organisation_name'] ?></h3>
    ...
    <div class="card-body">
      ...
      <div class="col-6">
        ...
        <p class="text-muted"><?php echo $row['address_detail'] ?></p>
        <hr>
      ...
      <div class="col-6">
        ...
        <p class="text-muted">
          Installer Name : <br />
          Vehicle Detail : <?php echo $row['vehicle_detail'] ?> <br />
