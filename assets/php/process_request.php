...
require_once 'auth_request.php';
require_once 'session.php';

$cuser = new Auth_request();
  ...
  $certificate = $cuser->get_all();
	...
	if ($certificate) {
        ...
        }else
        {
          ...
          $output .= '
                  <td>
                      <a href="view_hpdetails.php?uuid='.$row['uuid'].'" id="'.$row['id'].'" title="View" class="text-success infoBtn"><i class="fas fa-eye fa-lg"></i></a>&nbsp;
